    ...
    <div className="container mx-auto px-4 py-8 ">
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <QuickLink href="/artisan/shop" icon={<FaShoppingBag />}>
            My Shop
          </QuickLink>
          <QuickLink href="/artisan/jobPortal/all" icon={<FaBriefcase />}>
            Job Portal
          </QuickLink>
          <QuickLink href="/artisan/rentalMachines/all" icon={<FaCogs />}>
            Rental Machines
          </QuickLink>
          <QuickLink
            href="/artisan/workshop/all"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {userBookings.map((booking, index) => (
            ...
            >
              ...
              <Button
                variant="outline"
                className="bg-dori text-white hover:bg-dori/90"
              >
                View Details
              </Button>
            </div>
              ...
              <CardFooter className="px-4 py-3 bg-gray-50">
                <div className="flex flex-wrap gap-1">
                  {workshop.tags.slice(0, 3).map((badge, index) => (
                    <Badge
                      key={index}
                      className="px-1.5 py-0.5 text-[10px] bg-dori/20 text-dori hover:bg-dori/40 hover:text-white"
                    >
                      {badge}
                    </Badge>
                  ))}
          ...
          {featuredMachines.map((machine) => (
            ...
            >
              <CardContent className="p-4">
                ...
                <Button className="w-full bg-dori text-white hover:bg-dori/90">
                  Rent Now
                </Button>
              </CardContent>
              <CardFooter className="px-4 py-3 bg-gray-50">
...
function QuickLink({ href, children, icon }) {
  return (
    <Link
      href={href}
