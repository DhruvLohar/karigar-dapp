        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {workshopData.map((card, index) => (
            <Link
              ...
              className="block"
            >
              <Card className="h-full bg-white shadow-lg hover:shadow-xl transition-shadow duration-300 rounded-xl">
                <CardContent className="p-0">
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <Button
                        variant="outline"
                        className="bg-blue-950 text-white hover:bg-blue-950/10 text-xs px-2 py-1"
                      >
                        Learn More
                      </Button>
                    </div>
